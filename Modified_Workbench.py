...
def extract_frames(video_path, interval, clip_duration=8):
    ...
    process = (
        ...
        .output('pipe:', format='rawvideo', pix_fmt='rgb24',  r=fps, threads=8, loglevel="error") 
...
if __name__ == '__main__':
    ...
    for i in range(1, 11):
        ...
        if not frames:
            print(f"No frames extracted from {video_filename}. Skipping...")
            continue
        ...
        total_time = total_end_time - total_time_start
        frame_time = end_frames - total_start_time
        # Save results to CSV
        ...
        print(f"Total Frame Time: {frame_time:.4f} seconds")
